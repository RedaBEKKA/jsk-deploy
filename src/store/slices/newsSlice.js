  ...
  export const createNews = createAsyncThunk(
    ...
    async (data, { rejectWithValue }) => {
      ...
      try {
        ...
        console.log(response,'my resonse news');
  ...
  export const getOneNews = createAsyncThunk(
    ...
    async (id, { rejectWithValue }) => {
      try {
        ...
        console.log(response,'response get one news');
        return response.data;
      } catch (error) {
  ...
  const newsSlice = createSlice({
    ...
    .addCase(createNews.pending, (state) => {
        ...
        .addCase(updateNews.fulfilled, (state, action) => {
          ...
          const newsIndex = state.actualites.findIndex(
            (news) => news._id === id
          );
          if (newsIndex !== -1) {
        ...
        .addCase(deleteNews.fulfilled, (state, action) => {
          ...
          state.actualites = state.actualites.filter((news) => news._id !== newsId); 
          state.loading = false;
          state.error = null;
