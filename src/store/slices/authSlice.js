...
export const signUp = createAsyncThunk(
  ...
  console.log(data,'data register');
    ...
    try {
      ...
      console.log(response,'my resonse register');
      ...
      console.log(err.response.data.error,'error register');
      return rejectWithValue(err.response.data.error);
...
export const getUser = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      // const { id, email, username, roles, privileges } = response.data;

      // return { id, email, username, roles, privileges };
      console.log('get user indo',response.data)
      return response.data
    } catch (err) {
