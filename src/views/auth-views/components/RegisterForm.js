...
import { LockOutlined, MailOutlined, UserOutlined,UserAddOutlined,MessageOutlined,UploadOutlined,HomeOutlined } from "@ant-design/icons";
import { Button, Form, Input, Alert, AutoComplete,DatePicker,Upload,message } from "antd";
import {
  signUp,
  showAuthMessage,
  showLoading,
...
export const RegisterForm = (props) => {
  ...
  const validatePhoneNumber = (rule, value, callback) => {
    ...
    if (!phoneNumberPattern.test(value)) {
      callback('Le numéro de téléphone doit être au format +213 suivi de 9 chiffres.');
    } else {
      callback();
    }
  };
