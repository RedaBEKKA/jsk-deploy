...
import { createPlayer, getOnePlayer, updatePlayer,hideLoading } from "store/slices/joueurSlice";
...
const PlayerForm = (props) => {
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      console.log("Values palyer:", values);
      ...
      formData.append("numberOfMatches", values.numberOfMatches?values.numberOfMatches:0);
      ...
      formData.append("previousClubNumberOfMatches", values.previousClubNumberOfMatches);
      ...
      for (let obj of formData) {
        ...
        console.log(obj,'palyer');
       
      }
console.log(formData,'form player');
      ...
      if (mode === EDIT) {
        await dispatch(updatePlayer({ id: joueur._id, data: formData })
        ).unwrap();
