...
const StafList = () => {
  ...
  function generateCSV(data) {
    ...
    if (data) {
      ...
      console.log(data, 'my data export'); 
      ...
      <div className="table-responsive">
        {
          ...
          <Table columns={tableColumns} dataSource={filteredUsers} rowKey="_id" />
        }
