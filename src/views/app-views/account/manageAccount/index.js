...
import {  modifyAccount, hideLoading, hideError, showLoading } from "store/slices/accountSlice";
...
export const ManageAccount = () => {
  ...
  const { loading, showMessage, user } = useSelector(
    (state) => state.auth
  );
  console.log(user,'user gerer profil')
  // console.log(user.headName,'nom user')
